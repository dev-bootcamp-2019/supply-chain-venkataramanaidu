...
contract TestSupplyChain  {
        ...
        public
    {
        ...
        Assert.equal(state, 0, "Item State is `For sale`");
    ...
    function testUserDoesNotPaysTheRightPrice() public {
        ...
        Assert.equal(getItemState(itemSku), 0, "Item should be `ForSale`");
    }
    ...
    function testRandomUserCannotShipItem() public {
        ...
        // Verify state is Sold
        Assert.equal(getItemState(itemSku), 1, "Item should remain `Sold`");
    }
    ...
    function testSellerCanShipItem() public {
        ...
        Assert.equal(getItemState(itemSku), 2, "Item should be `Shipped`");
    }
    ...
    function testCannotShipAnItemThatIsNotSold() public {
        ...
        // Verify state is ForSale
        Assert.equal(getItemState(itemSku), 0, "Item should remain `ForSale`");
    }
    ...
    function testNonBuyerCannotSetItemAsReceived() public {
        ...
        // Verify state is Shipped
        Assert.equal(getItemState(itemSku), 2, "Item should remain `Shipped`");
    }
    ...
    function testBuyerCanSetItemAsReceived() public {
        ...
        // Verify state is Shipped
        Assert.equal(getItemState(itemSku), 3, "Item should be `Received`");
    }
